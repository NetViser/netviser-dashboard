...
import { fetchAttackBeeswarmSummaryXAIExplanation } from "@/utils/client/fetchAttackSummaryXAI";
...
type BeeswarmSummarySectionProps = {
  attackType: string;
  beeswarmSummaryData: any; // Replace with actual type if available
  isLoading: boolean;
};

export function BeeswarmSummarySection({
  attackType,
  beeswarmSummaryData,
  isLoading,
