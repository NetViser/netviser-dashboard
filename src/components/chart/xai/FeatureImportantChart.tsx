...
import { BarSummaryItem } from "@/lib/api/fetchAttackSummaryXAI";
import { FaExpandAlt } from "react-icons/fa";
import { Button } from "@/components/ui/button";

type FeatureImportantChartProps = {
  minimal?: boolean;
  attackType: string;
  data: BarSummaryItem[];
  onHelpClick?: () => void;
...
export default function FeatureImportantChart({
  minimal = false,
  attackType,
  data,
  onHelpClick,
}: FeatureImportantChartProps) {
